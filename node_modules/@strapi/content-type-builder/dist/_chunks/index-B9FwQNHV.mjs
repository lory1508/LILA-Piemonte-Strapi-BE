...
const ListView$1 = lazy(() => import("./ListView-Bq8Xz_Sr.mjs"));
const RecursivePath = () => {
...
const ListView = lazy(() => import("./ListView-Bq8Xz_Sr.mjs"));
const App = () => {
  const { formatMessage } = useIntl();
...
//# sourceMappingURL=index-B9FwQNHV.mjs.map
