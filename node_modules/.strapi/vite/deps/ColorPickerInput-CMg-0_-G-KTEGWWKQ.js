...
// node_modules/@strapi/plugin-color-picker/dist/_chunks/ColorPickerInput-CMg-0_-G.mjs
...
var m = import_react.default.memo(function(o2) {
  ...
  return (0, import_react.useEffect)(function() {
    return H;
  }, [H]), import_react.default.createElement("div", u({}, s2, { onTouchStart: C2, onMouseDown: C2, className: "react-colorful__interactive", ref: m2, onKeyDown: E, tabIndex: 0, role: "slider" }));
});
var g = function(e2) {
...
`;
var ColorPickerToggle = dt(Button)`
  & > span {
    display: flex;
...
`;
var ColorPickerPopover = dt(Popover.Content)`
  padding: ${({ theme }) => theme.spaces[2]};
  min-height: 270px;
`;
var ColorPickerInput = React.forwardRef(
  ({ hint, disabled = false, labelAction, label, name, required = false, onChange, value, error }, forwardedRef) => {
    ...
    return (0, import_jsx_runtime.jsx)(Field.Root, { name, id: name, error, hint, required, children: (0, import_jsx_runtime.jsxs)(Flex, { direction: "column", alignItems: "stretch", gap: 1, children: [
      (0, import_jsx_runtime.jsx)(Field.Label, { action: labelAction, children: label }),
      (0, import_jsx_runtime.jsxs)(Popover.Root, { onOpenChange: setShowColorPicker, children: [
        (0, import_jsx_runtime.jsx)(Popover.Trigger, { children: (0, import_jsx_runtime.jsxs)(
          ColorPickerToggle,
          {
            ref: composedRefs,
            ...
            children: [
              (0, import_jsx_runtime.jsxs)(Flex, { children: [
                (0, import_jsx_runtime.jsx)(ColorPreview, { color }),
              ...
              (0, import_jsx_runtime.jsx)(ForwardRef$4D, { "aria-hidden": true })
            ]
          }
        ) }),
        (0, import_jsx_runtime.jsxs)(ColorPickerPopover, { sideOffset: 4, children: [
          (0, import_jsx_runtime.jsx)(ColorPicker, { color, onChange: (hexValue) => onChange(name, hexValue) }),
          (0, import_jsx_runtime.jsxs)(Flex, { paddingTop: 3, paddingLeft: 4, justifyContent: "flex-end", children: [
            (0, import_jsx_runtime.jsx)(Box, { paddingRight: 2, children: (0, import_jsx_runtime.jsx)(Typography, { variant: "omega", tag: "label", textColor: "neutral600", children: formatMessage({
              id: getTrad("color-picker.input.format"),
              defaultMessage: "HEX"
            }) }) }),
            (0, import_jsx_runtime.jsx)(Field.Root, { children: (0, import_jsx_runtime.jsx)(
              Field.Input,
              {
                "aria-label": formatMessage({
...
//# sourceMappingURL=ColorPickerInput-CMg-0_-G-KTEGWWKQ.js.map
